...
def amatersu_handsign():
    ...
    try:
        ...
        #load images
        amatersu_background_img = pygame.image.load('files/Background/sharingan_background.png').convert_alpha()
        stamp_img = pygame.image.load('files/Icons/stamp.png').convert_alpha()
        clip = VideoFileClip('files/Videos/sharingan.mp4')
        ...
        def draw_jitsu_bg():
            screen.blit(amatersu_background_img, (0, 0))
