...
def fireball_handsign():
    ...
    try:
        ...
        #load images
        fireball_background_img = pygame.image.load('files/Background/fireball_background.png').convert_alpha()
        stamp_img = pygame.image.load('files/Icons/stamp.png').convert_alpha()
        clip = VideoFileClip('files/Videos/fireball_jitsu.mp4')
        ...
        def draw_jitsu_bg():
            screen.blit(fireball_background_img, (0, 0))
